...
if [ -r "$CATALINA_BASE/bin/mariadb-java-client-1.8.0.jar" ] ; then
  CLASSPATH=$CLASSPATH:$CATALINA_BASE/bin/mariadb-java-client-1.8.0.jar
else
  CLASSPATH=$CLASSPATH:$CATALINA_HOME/bin/mariadb-java-client-1.8.0.jar
fi
